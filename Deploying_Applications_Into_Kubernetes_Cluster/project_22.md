...
```
![](./images/pod-info-yaml.png)

OR
```bash
kubectl describe pod nginx-pod
```
![](./images/describ-pod.png)
...
EOF
```
![](./images/update-service-file.png)
